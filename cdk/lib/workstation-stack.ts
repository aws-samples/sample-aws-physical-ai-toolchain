...
export class WorkstationStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: WorkstationStackProps) {
    ...
    userData.addCommands(
      ...
      '',
      'echo "=== Step 10: Clone toolchain repo ==="',
      ...
      '',
      'echo "=== Step 11: Create convenience scripts ==="',
      'cat > /home/ubuntu/run-isaac-lab.sh << \'RUNSCRIPT\'',
      '#!/bin/bash',
      '# Run Isaac Lab training (headless) — same as SageMaker',
      'docker run --gpus all --rm \\',
      '  802782083985.dkr.ecr.us-east-1.amazonaws.com/physical-ai/isaac-lab:latest \\',
      '  train',
      'RUNSCRIPT',
      'chmod +x /home/ubuntu/run-isaac-lab.sh',
      'chown ubuntu:ubuntu /home/ubuntu/run-isaac-lab.sh',
      '',

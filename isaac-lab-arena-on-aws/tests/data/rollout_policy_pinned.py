...
#
# Source:  https://github.com/NVIDIA/Isaac-GR00T at 376ba890cff8c9de64d71d982772a9c36185fdd7
# Licence: Apache-2.0
# Copyright (c) 2025 NVIDIA CORPORATION & AFFILIATES. All rights reserved.
#
# I13: this repository redistributes upstream source, publicly. Apache-2.0 requires the copyright and
# attribution notices to be retained in copies, so they travel with the copy rather than only
# being listed in NOTICE. A test fixture is still a copy.
# ---------------------------------------------------------------------------------------------

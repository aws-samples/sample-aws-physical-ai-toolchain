# Cosmos Transfer 2.5 Deployment Guide

How to deploy and run NVIDIA Cosmos Transfer 2.5-2B for photorealistic scene generation. This guide captures everything learned during development — use it to replicate or troubleshoot the deployment.
